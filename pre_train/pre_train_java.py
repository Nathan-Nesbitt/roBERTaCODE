...
tokenizer = RobertaTokenizerFast.from_pretrained("tokenizer_java")
...
dataset = LineByLineTextDataset(
    tokenizer=tokenizer,
    file_path="./data/train_java_large.txt",
    block_size=128,
)
...
training_args = TrainingArguments(
    output_dir="./roBERTaCODE_java_large",
...
trainer.save_model("./roBERTaCODE_java_large")
